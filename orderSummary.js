...
import { products, getProduct } from '../utils/products.js';
...
document.querySelector('.js-return-to-home-link')
  ...
  .forEach((inputElement) => {
    inputElement.addEventListener('keydown', (event) => {
      if (event.key === 'Enter') {
        const container = inputElement.closest('.cart-item-container');
        const productId = container.classList[1].split('js-cart-item-container-')[1];
